  ...
  return (
    <Panel title="Spillemåte" isOpen={isOpen} close={close}>
      <div className="space-y-3 text-justify border-b-2 border-gray-200 pb-3 mb-3">
        <div>
        Gjett riktig kommune på seks forsøk. Hver gjetning må være en norsk kommune.
        </div>
        <div>
        ...
        <div>
          ...
          <div className="my-2">
            Din første gjetning <span className="uppercase font-bold">Vadsø</span> er 
              {formatDistance(1195000, settingsData.distanceUnit)} unna riktig kommune, den riktige kommunen ligger sørvestover.
          </div>
        </div>
        <div>
          <Guesses
          ...
          />
          <div className="my-2">
            Din andre gjetning <span className="uppercase font-bold">Tydal</span> er nærmere og {formatDistance(127000, settingsData.distanceUnit)} unna riktig kommune. Den riktige kommunen ligger vestover.
          </div>
        </div>
        <div>
          <Guesses
      ...
      <div className="space-y-3 text-justify border-b-2 border-gray-200 pb-3 mb-3">
        ...
        <div>
          Avstandene som brukes er mellom midtpunkteti hver kommune. Selv nabokommuner har dermed mer enn 0 i avstand.
        </div>
      </div>
      <div className="space-y-3 text-justify border-b-2 border-gray-200 pb-3 mb-3">
